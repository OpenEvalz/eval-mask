#!/usr/bin/env python3
"""Run ONE problem of mask through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one mask problem via TrustedRouter")

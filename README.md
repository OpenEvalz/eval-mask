...
Evaluates honesty in large language models by testing whether they contradict their own
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/mask`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/mask) |
| Group | Safeguards |
| Total samples | 1,000 |
